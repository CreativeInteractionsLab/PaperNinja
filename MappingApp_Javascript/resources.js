...
var res = {
    ...
    arrowTL_png: app.CreateImage("Img/arrow-tl-up.png"),
    arrowTR_png: app.CreateImage("Img/arrow-tr-up.png"),
    arrowBL_png: app.CreateImage("Img/arrow-bl-up.png"),
    arrowBR_png: app.CreateImage("Img/arrow-br-up.png")
};
